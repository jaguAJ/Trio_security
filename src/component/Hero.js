...
function Hero() {
  ...
  return (
    <section className="relative inset-0 bg-no-repeat bg-cover bg-center min-h-[450px] sm:min-h-[210px] md:min-h-[826px] bg-opacity-50 filter brightness-20 md:brightness-100 md:opacity-100 max-w-full mb-[1.4rem] sm:mb-[1.7rem] md:mb-[3.4rem] bg-hero-desktop bg-hero-mobile ">
      <div className="absolute top-[5%] left-0 md:top-[15%] md:right-[50%] flex flex-col gap-[1rem] md:gap-[4rem] max-w-[80rem] md:max-w-[70rem] mx-auto px-[2rem] md:px-[5.2rem] py-[2rem] md:py-[7rem] text-[#0c034a] min-h-full">
        ...
        <div className="max-w-full flex flex-col justify-around md:block">
          <div className="max-w-full sm:mt-[80px] md:mt-[200px]">
            <p className="relative hidden md:block sm:mt-[19.5px] md:mt-[39px] font-sans font-medium text-[10px] sm:text-[12px] md:text-[18px] text-[#000] leading-[1.6]">
